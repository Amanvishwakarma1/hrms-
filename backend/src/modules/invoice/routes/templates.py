...
def get_default_template_sections() -> List[Dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "enabled": True,
            "fields": [
                {"key": "name", "label": "Consumer Name", "type": "Text", "required": True, "editable": True, "read_only": False, "hidden": False, "searchable": True, "filterable": True, "sortable": True, "exportable": True, "api_visible": True, "dashboard_visible": True, "confidence_threshold": 80, "default_value": "", "validation_rule": "", "placeholder": "HRMSS PRIVATE LIMITED", "tooltip": "Buyer legal name", "display_order": 1, "ai_prompt": "Extract the legal name of the buyer/customer."},
